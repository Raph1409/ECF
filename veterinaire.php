...
<header>
    <?php
    session_start(); 
    require 'front/headerVeterinaire.php'; ?>
</header>
...
<body>
    ...
    <div class="body mx-auto">
        <p>Connexion réussie ! Bienvenue
            <?php echo $_SESSION["user"]["prenom"] ."," . "<br>" ." Vous êtes connecté en tant que Vétérinaire" . "<br>" . "sous le pseudo : " . $_SESSION["user"]["username"] . "<br>" ?>
        </p>
