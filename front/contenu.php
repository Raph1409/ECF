...
<head>
    <link href="styleCSS/styleContenu.css" rel="stylesheet">
</head>

<body>
    <div class="centrer mx-auto">
        <p>Au Zoo Écologique Arcadia, nous vous invitons à découvrir un lieu où l'harmonie entre l'homme et la nature
            prend
            tout son sens.
            ...
            Nous croyons que la conservation passe par la compréhension, c'est pourquoi nous nous engageons dans des
            programmes de sensibilisation et d'éducation à la faune et à la flore.
        </p>

        <img src="../images/elephant.jpg" class="img-fluid" alt="Responsive image" alt="Bootstrap" width="1500"
            height="366.02">

        <p>À travers des expositions interactives, des animations pédagogiques et des rencontres avec des experts,
