...
<body>
    ...
    LEFT JOIN habitats ON animaux.habitat = habitats.habitat_id WHERE habitats.nom = 'Jungle'";
    ...
    $raceImages = [
        "Tigre"=> "images/tigre2.jpg",
        "Jaguar"=> "images/leopard.jpg",
        "Bonobo"=> "images/bonobo.jpg",
        "Lémur Vari"=> "images/lemur.png",
        "Orang-outan"=> "images/orang.jpg",
        "Gorille"=> "images/gorille.jpg",
    ];
